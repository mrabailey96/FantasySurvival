...
#include "FS_AttributeSet_Stats_.generated.h"
 ...
 */
UCLASS()
class FANTASYSURVIVAL_API UFS_AttributeSet_Stats_ : public UAttributeSet
{
	GENERATED_BODY()
	
public:
    UFS_AttributeSet_Stats_();
